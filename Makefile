...
all:data/online_shoppers_intention.csv \
	...
	data/model-train-test/x_train.csv data/model-train-test/x_test.csv data/model-train-test/y_train.csv data/model-train-test/y_test.csv \
...
# data_split
data/model-train-test/x_train.csv data/model-train-test/x_test.csv data/model-train-test/y_train.csv data/model-train-test/y_test.csv: data/cleaned/cleaned_features.csv data/cleaned/cleaned_targets.csv
	python src/data_split.py data/cleaned/cleaned_features.csv data/cleaned/cleaned_targets.csv data/model-train-test/x_train.csv data/model-train-test/x_test.csv data/model-train-test/y_train.csv data/model-train-test/y_test.csv

# pre-process data
data/preprocessed/preprocessed_train_data.csv data/preprocessed/preprocessed_test_data.csv: data/model-train-test/x_train.csv data/model-train-test/x_test.csv data/model-train-test/y_train.csv data/model-train-test/y_test.csv
	python src/preprocessing.py data/model-train-test/x_train.csv data/model-train-test/x_test.csv data/model-train-test/y_train.csv data/model-train-test/y_test.csv data/preprocessed/preprocessed_train_data.csv data/preprocessed/preprocessed_test_data.csv
