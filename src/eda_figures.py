...
def visualize_data(data_file, figure_prefix):
    ...
    axs[0].set_title('Figure 7a: Distribution of Sessions by Visitor Type')
    axs[0].legend()
    ...
    axs[1].set_title('Figure 7b: Number of Purchases (Revenue=True) by Visitor Type')
    ...
    axs[0].set_title('Figure 8a: Distribution of Sessions by Weekend')
    axs[0].legend()
    ...
    axs[1].set_title('Figure 8b: Number of Purchases (Revenue=True) by Weekend')
