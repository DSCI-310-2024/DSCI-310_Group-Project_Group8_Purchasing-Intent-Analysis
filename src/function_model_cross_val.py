...
def model_cross_validation(preprocessed_training_data, preprocessed_testing_data, target, k, gamma):
    """
    Calculates the cross validation results for four common off-the-shelf models (Dummy, KNN, SVM, and RandomForests)
    ...
    - k: int, k value hyperparameter for KNearestNeighbours
    - gamma: float, gamma value hyperparameter for SVM
